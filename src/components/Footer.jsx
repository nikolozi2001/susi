      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-susi-beige text-sm">
              © {year} {t("reports.stateSecurityService")}{". "}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    ...
                    className="text-susi-beige hover:text-white"
                  >
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link
                    to="/info/international-cooperation"
                    className="text-susi-beige hover:text-white"
                  >
        ...
        <div className="border-t border-susi-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center">
          <div className="flex space-x-6 mb-4 md:mb-0">
            <Link
              to="/privacy"
              className="text-susi-beige text-sm hover:text-white"
            >
              {t("footer.privacy")}
            </Link>
            <Link
          ...
          <div className="flex space-x-4">
            ...
            >
              <svg
                className="h-5 w-5 text-susi-beige hover:text-white"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
